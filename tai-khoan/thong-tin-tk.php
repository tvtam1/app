		...
		<div class="container-login100" style="background-image: url('../css/tai-khoan/images/bg-01.jpg');">
			<div class="wrap-login100">
				<form class="login100-form validate-form" method = "post">
					...
					<a href="../../trang-chinh/index.php"><img src="https://scontent.fpnh22-2.fna.fbcdn.net/v/t1.6435-9/181150315_102201648705132_5894264111956944146_n.png?_nc_cat=100&ccb=1-3&_nc_sid=09cbfe&_nc_ohc=OtiUo2flbdEAX_dyQES&_nc_ht=scontent.fpnh22-2.fna&oh=db19836dfddbf8cf02e942468bcdd64b&oe=60BD403A" width = "80px" alt=""></a>
					</span>
					...
					<div class="text-center p-t-90">
						...
						<a class="txt1" href="../../tai-khoan/doi-mk.php.php">
							Đổi mật khẩu ?
						</a>
					</div>
				</form>
